...
def reporter_node(state: State, config: RunnableConfig):
    ...
    # Context compression
    reporter_llm_type = AGENT_LLM_MAP["reporter"]
    llm_token_limit = get_llm_token_limit_by_type(reporter_llm_type)
    llm_model_name = get_llm_model_name_by_type(reporter_llm_type)
    compressed_state = ContextManager(
        llm_token_limit, llm_type=reporter_llm_type, model_name=llm_model_name
    ).compress_messages({"messages": observation_messages})
