...
import { Check, FileText, Newspaper, Users, GraduationCap, TrendingUp, GitBranch } from "lucide-react";
...
const REPORT_STYLES = [
  ...
  {
    value: "tech_selection" as const,
    labelKey: "techSelection",
    descriptionKey: "techSelectionDesc",
    icon: GitBranch,
  },
];
...
export function ReportStyleDialog() {
  ...
  const handleStyleChange = (
    style: "academic" | "popular_science" | "news" | "social_media" | "strategic_investment" | "tech_selection",
  ) => {
