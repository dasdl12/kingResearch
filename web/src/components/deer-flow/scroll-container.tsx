...
export function ScrollContainer({
  ...
  // If scrollShadowTop/Bottom not specified, use scrollShadow value
  const showTopShadow = scrollShadowTop !== undefined ? scrollShadowTop : scrollShadow;
  const showBottomShadow = scrollShadowBottom !== undefined ? scrollShadowBottom : scrollShadow;
